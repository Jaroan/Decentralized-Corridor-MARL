...
#SBATCH --job-name forced_basic_corridor
#SBATCH -a 0-1
...
--project_name "basic_corridor_${n_agents}" \
--env_name "GraphMPE" \
--model_dir "model_weights/FA_FR/tube" \
--algorithm_name "rmappo" \
--seed ${seeds[$SLURM_ARRAY_TASK_ID]} \
--experiment_name "${str_dynamics_type}_${datetime_str}_basic_corridor_forced_order_eplen${episode_length}" \
--scenario_name "basic_corridor_graph" \
...
&> $logs_folder/${str_dynamics_type}_${datetime_str}_basic_corridor_forced_order_eplen${episode_length}_${seeds[$SLURM_ARRAY_TASK_ID]}
