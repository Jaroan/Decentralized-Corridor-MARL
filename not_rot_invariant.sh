...
--scenario_name "nav_graph_metered_single_corridor_not_rot_inv" \
...
&> $logs_folder/${str_dynamics_type}_${datetime_str}_not_rot_inv_tube_eplen${episode_length}_${seeds[$SLURM_ARRAY_TASK_ID]}