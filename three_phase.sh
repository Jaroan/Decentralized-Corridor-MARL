...
--experiment_name "${str_dynamics_type}_${datetime_str}_three_phase_with_coll_spacing10_eplen${episode_length}" \
...
&> $logs_folder/${str_dynamics_type}_${datetime_str}_three_phase_with_coll_spacing10_eplen${episode_length}_${seeds[$SLURM_ARRAY_TASK_ID]}