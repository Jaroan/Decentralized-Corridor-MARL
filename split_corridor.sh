...
--model_dir "model_weights/FA_FR/tube/feb17/no_transfer_metered" \
--experiment_name "${str_dynamics_type}_${datetime_str}_random_actualsplit_corr_metered5_disconnect_done_tube_eplen${episode_length}" \
--scenario_name "nav_metered_one_goal_graph_sequential_split_tube" \
...
&> $logs_folder/${str_dynamics_type}_${datetime_str}_random_actualsplit_corr_disconnect_done_tube_eplen${episode_length}_${seeds[$SLURM_ARRAY_TASK_ID]}
