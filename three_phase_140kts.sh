...
#SBATCH --job-name 3_140rot_col20
#SBATCH -a 0-1
...
--experiment_name "${str_dynamics_type}_${datetime_str}_with140kts_coll20_spacing10_rot_eplen${episode_length}" \
...
&> $logs_folder/${str_dynamics_type}_${datetime_str}_with140kts_coll20_spacing10_rot_eplen${episode_length}_${seeds[$SLURM_ARRAY_TASK_ID]}