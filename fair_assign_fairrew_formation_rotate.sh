...
--experiment_name "${str_dynamics_type}_${datetime_str}_rotatube_fafr_eplen${episode_length}_nowalls_formation_nocollab_1Fair_30goal" \
--scenario_name "nav_fairassign_fairrew_formation_graph_rotate_tube" \
...
&> $logs_folder/${str_dynamics_type}_${datetime_str}_rotatube_fairassign_fairrew_eplen${episode_length}_nowalls_GoalMatch_GPU_1Fair_30goal_${seeds[$SLURM_ARRAY_TASK_ID]}
