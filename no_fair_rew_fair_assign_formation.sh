...
--experiment_name "${str_dynamics_type}_${datetime_str}_currRew_AllPhasespacing_lowVel_formation_random_tube_fa_eplen${episode_length}" \
...
&> $logs_folder/${str_dynamics_type}_${datetime_str}_currRew_AllPhasespacing_lowVelformation_random_tube_fairassign_eplen${episode_length}_${seeds[$SLURM_ARRAY_TASK_ID]}
