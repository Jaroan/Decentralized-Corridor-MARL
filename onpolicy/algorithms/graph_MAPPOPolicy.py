...
class GR_MAPPOPolicy:
    ...
    def get_actions(self, 
        ...
        #     print("POLICY available_actions",available_actions.shape, available_actions)
        actions, action_log_probs, rnn_states_actor = self.actor.forward(obs,
                                                            node_obs,
                                                            adj,
                                                            agent_id,
                                                            rnn_states_actor,
        ...
        values, rnn_states_critic = self.critic.forward(cent_obs,
                                                node_obs,
                                                adj,
                                                share_agent_id,
                                                rnn_states_critic, 
    ...
    def get_values(self, 
        ...
        """
        values, _ = self.critic.forward(cent_obs, 
                                        node_obs, 
                                        adj, 
                                        share_agent_id,
                                        rnn_states_critic, 
    ...
    def act(self, 
        ...
        """
        # if available_actions is not None:
        #     print("POLICYAvailable actions", available_actions.shape, available_actions)
        actions, _, rnn_states_actor = self.actor.forward(obs,
                                                        node_obs,
                                                        adj,
                                                        agent_id,
                                                        rnn_states_actor, 
                                                        ...
                                                        available_actions, 
                                                        deterministic)
        # print("PolicyActions", actions.shape, actions)
