...
class MultiAgentEnv(gym.Env):
    ...
    def step(self, action_n):
        ...
        for i, agent in enumerate(self.agents):
            ...
            print("self._get_reward(agent)", self._get_reward(agent), reward_n)
            done_n.append(self._get_done(agent))
            print("self._get_done(agent)", self._get_done(agent), done_n)
    ...
    def _get_done(self, agent):
        # print("self.done_callback", self.done_callback")
