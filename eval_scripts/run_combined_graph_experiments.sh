#!/bin/bash
# Run simple combined graph experiments with different agent counts
...
echo "Running simple combined graph experiments..."
echo ""
...
#   --eval_mode \
#   --eval_output_dir="eval_combined_graph_10agents" \
#   --save_trajectories
...
#   --formation_type='point' \
#   --eval_mode \
#   --eval_output_dir="eval_combined_graph_20agents" \
#   --save_trajectories
...
#   --formation_type='point' \
#   --eval_mode \
#   --eval_output_dir="eval_combined_graph_30agents" \
#   --save_trajectories
...
python onpolicy/scripts/eval_mpe.py \
  ...
  --formation_type='point' \
  --eval_mode \
  --eval_output_dir="eval_combined_graph_40agents" \
  --save_trajectories
...
echo "  python eval_scripts/compute_combined_graph_average_speeds.py"
