#!/usr/bin/env python
"""
Compute average speeds for double merge corridor experiments.

Analyzes trajectory data from different agent counts and computes average speeds.

Usage:
    python eval_scripts/compute_double_merge_average_speeds.py
"""
...
def main():
    print("\n" + "="*80)
    print("DOUBLE MERGE CORRIDOR AVERAGE SPEED ANALYSIS")
    print("="*80 + "\n")

    # Experiment configurations
    experiments = [
        {"num_agents": 10, "num_episodes": 50, "dir": "eval_double_merge_10agents"},
        {"num_agents": 20, "num_episodes": 50, "dir": "eval_double_merge_20agents"},
        {"num_agents": 30, "num_episodes": 50, "dir": "eval_double_merge_30agents"},
        {"num_agents": 40, "num_episodes": 10, "dir": "eval_double_merge_40agents"},
    ]
    ...
    # Save to CSV
    output_file = "double_merge_corridor_average_speeds.csv"
