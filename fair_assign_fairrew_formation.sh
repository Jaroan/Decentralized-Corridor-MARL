...
#SBATCH --job-name forced_coverage
#SBATCH -a 0-1
...
--experiment_name "${str_dynamics_type}_${datetime_str}_currRew_forced_orderAllPhasespacing_tube_fafr_eplen${episode_length}" \
...
&> $logs_folder/${str_dynamics_type}_${datetime_str}_currRew_forced_orderAllPhasespacing_lowVel_fairassign_fairrew_eplen${episode_length}_${seeds[$SLURM_ARRAY_TASK_ID]}
