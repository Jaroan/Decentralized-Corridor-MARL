...
--experiment_name "${str_dynamics_type}_${datetime_str}_seq_metered5_disconnect_done_tube_eplen${episode_length}" \
--scenario_name "nav_metered_one_goal_graph_sequential" \
...
&> $logs_folder/${str_dynamics_type}_${datetime_str}_seq_disconnect_done_tube_eplen${episode_length}_${seeds[$SLURM_ARRAY_TASK_ID]}
