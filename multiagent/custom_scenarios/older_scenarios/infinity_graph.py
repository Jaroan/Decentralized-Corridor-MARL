...
class Scenario(BaseScenario):
	...
	def info_callback(self, agent:Agent, world:World) -> Tuple:
		...
		# print("distance_to_center1",distance_to_center1,"distance_to_center2",distance_to_center2,"dist to center", dist, 2.5*(self.target_radius/2))
		...
		if distance_to_center1 < 2.5*(self.target_radius/2) or distance_to_center2 < 2.5*(self.target_radius/2):
			...
			# print("dist", distance_to_center1, distance_to_center2, 2.5*(self.target_radius/2))
